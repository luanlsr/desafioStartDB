...
const resultByCustomFilterMapReduce = olympicsMedalTable.customFilter(element => element.continent === "ASIA")
...
const paisesCom30MedalhasNoMinimo = olympicsMedalTable
    .customFilter(item => item.gold + item.silver + item.bronze >= 30)
...
const paisesComPeloMenos20MedalhasDeOUro = olympicsMedalTable
    .customFilter(item => item.continent === "AMERICA DO SUL")
    .customReduce((acc, value) => acc + value.gold) >= 20 ? true: false;
